    ...
    <div class="block-form container">
        <form method="POST"
            ...
            <input name="description" type="text"
                   ...
                   placeholder="Короткая информация о городе"
            ...
            <button type="submit" class="block-form__button text-center w-full bg-blue-900 rounded-md text-white py-3 font-medium"
                    value="save">
                Сохранить
            </button>
        </form>
