...
<div class="form-group col">
    ...
    <input type="hidden" name="user_id" value="{{$user->id}}">
    <input name="phone" type="tel" class="form-control block-form__input @error('phone') block-form__input_error @enderror"
    ...
    <input type="text" class="form-control" class="location" placeholder="" name="location" 
...
<div class="form-group col">
    ...
    <input type="text" class="form-control" id="personalinfo" placeholder="" name="personalinfo" 
